...
public class CustomerAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    public CustomerAdapterHistory(com.example.bankingapplication.HistoryList historyList, List<Model> modelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.transfer_history_list_recycler, parent, false);
